...
type ScheduledMessageStore interface {
	...
	GetScheduledMessage(ctx context.Context, id common.ID) (*model.ScheduledMessage, error)
	DeleteScheduledMessage(ctx context.Context, id common.ID) error
	...
	UpdateScheduledMessageNextAt(ctx context.Context, id common.ID, nextAt time.Time) error
	UpdateScheduledMessageEnabled(ctx context.Context, id common.ID, enabled bool) error
}
