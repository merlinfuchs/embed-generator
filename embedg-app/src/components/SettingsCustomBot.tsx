  ...
  return (
    <div className="bg-ink-700 rounded-lg p-5">
      ...
      {!customBot?.success || confiure ? (
        customBotAllowed ? (
          <div>
            <div className="text-lg font-medium text-mist-300 mb-1">
              Bot Token
            </div>
            <div className="text-mist-400 font-light text-sm mb-5">
              You get the token by creating a bot in the Discord Developer
              Portal.
            </div>
            <input
              type="password"
              className="px-3 py-2 bg-ink-900 w-full rounded-lg mb-10 focus:outline-none text-mist-300"
              value={token}
              onChange={(e) => setToken(e.target.value)}
            />
            <div className="flex justify-end space-x-3">
              <button
                className="px-3 py-2 rounded-lg bg-azure-500 hover:bg-azure-500 cursor-pointer text-white"
                onClick={save}
              >
                Save
              </button>
        ...
        <div>
            ...
            <div className="flex justify-between mb-10">
              <div className="flex items-center space-x-3">
                <div className="relative">
                  ...
                  />
                  <div
                    className="h-5 w-5 bg-ink-700 rounded-full absolute right-0 bottom-0 flex items-center justify-center"
                    title="Change Status"
                  >
                    <div
                      className={clsx(
          ...
          <div className="flex flex-col text-mist-300 space-y-5 mb-10">
          ...
          <div className="mb-10">
            ...
            <div className="flex space-x-3">
              <select
                className="px-3 py-2 rounded-lg bg-ink-900 text-mist-300"
                value={status}
              ...
              <input
                className="px-3 py-2 bg-ink-900 rounded-lg focus:outline-none text-mist-300"
              ...
              <button
                ...
                className="bg-ink-600 rounded-lg px-3 py-2 text-white hover:bg-ink-600 flex-none"
              >
                Save
              </button>
            </div>
          ...
          <div className="mb-10">
            ...
            <input
              ...
              className="bg-ink-900 px-3 py-2 rounded-lg w-full focus:outline-none text-white mb-5"
            />
            <a
