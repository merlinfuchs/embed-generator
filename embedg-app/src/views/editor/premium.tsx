          ...
          <div className="space-y-2 mt-4 mb-5">
            <div className="p-4 bg-dark-3 rounded flex space-x-3 items-center">
              ...
              <div className="text-gray-400 font-light text-sm">
                Save up to{" "}
                <span className="font-medium text-white">50 messages</span> and
                load them whenever you need them
              </div>
            </div>
            <div className="p-4 bg-dark-3 rounded flex space-x-3 items-center">
            ...
            <div className="p-4 bg-dark-3 rounded flex space-x-3 items-center">
              ...
              <div className="text-gray-400 font-light text-sm">
                Respond to interactive components with a saved message including
                embeds and other interactive components
              </div>
            </div>
            <div className="p-4 bg-dark-3 rounded flex space-x-3 items-center">
