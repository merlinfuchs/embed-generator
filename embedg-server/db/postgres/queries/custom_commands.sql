...
INSERT INTO custom_commands (id, guild_id, name, description, parameters, actions, created_at, updated_at) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *;

-- name: UpdateCustomCommand :one
UPDATE custom_commands SET name = $3, description = $4, enabled = $5, actions = $6, parameters = $7, updated_at = $8 WHERE id = $1 AND guild_id = $2 RETURNING *;
