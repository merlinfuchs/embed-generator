...
SELECT token_hash, user_id, access_token, created_at, expires_at FROM sessions WHERE token_hash = $1
`
...
SELECT token_hash, user_id, access_token, created_at, expires_at FROM sessions WHERE user_id = $1
`
...
INSERT INTO sessions (token_hash, user_id, access_token, created_at, expires_at) VALUES ($1, $2, $3, $4, $5) RETURNING token_hash, user_id, access_token, created_at, expires_at
`
